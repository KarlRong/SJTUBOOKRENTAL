...
<html>
	...
	<body >
		...
		<h1 style="text-align: center;">本人借入图书</h1><br>
		<div  align="center">
		...
		<table style="background-color:#99bbbb;" border="1" align="center">
			<tr>
				<td colspan="4" style="background-color:#99bbbb;">
					<h2 style="text-align: center;">本人借入图书列表</h2>
				</td>
			</tr>
...
//    echo "数据库连接成功" . "<br>";
        ...
        $sql = "SELECT * FROM `book` WHERE `borrowerid` = '{$_SESSION['validate']['pnumber']}' ";
        $result = $conn->query($sql);
...
HTML;
        if( $row["state"] == 0){
            echo	<<< HTML
                 <td style="background-color:#EEEEEE;height:100px;width:200px;text-align:center;"> <input type="text" id="field1" value="已借阅" style="border:none;height:30px;width:100px;font-size:20px;background-color:#EEEEEE;"><br></td> 
				...
				<input type="submit" name="button" style="height:30px;width:100px;text-align:center;font-size:20px;" value="还书"></button> </td>
				</form>-->
				</tr> 
HTML;
        } else {
            echo	<<< HTML
                 <td style="background-color:#EEEEEE;height:100px;width:200px;text-align:center;"> <input type="text" id="field1" value="尚未借到" style="border:none;height:30px;width:100px;font-size:20px;background-color:#EEEEEE;"><br></td> 
				<!--<td style="background-color:#EEEEEE;height:100px;width:200px;text-align:center;">
				<input type="button" disabled="disabled" onclick="changeText()" id="button1" style="height:30px;width:100px;text-align:center;font-size:20px;" value="还书"></button> </td>-->
				</tr> 
HTML;
        }
    }
